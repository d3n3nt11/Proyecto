...
export default function InformeStock() {
    ...
    useEffect(() => {
        ...
        const cargarDatos = async () => {
            setLoading(true);
            try {
                const data = await getStockMovementsPorFechas(startDate, endDate);
                setMovimientos(data);
            } catch (error) {
    ...
    const handleDescargar = async () => {
        ...
        try {
            ...
            a.href = url;
            a.download = `stock_movimientos_${startDate}_${endDate}.csv`;
            a.click();
    ...
    // Helpers para mostrar badges con colores
